...
jlong Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamEncode(JNIEnv*, jclass, jlong, jobject);
jboolean Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamDecode(JNIEnv*, jclass, jlong, jlong, jfloatArray, jintArray, jfloatArray, jobject);
void Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamReleaseEmbedding(JNIEnv*, jclass, jlong);
jintArray Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamGetEmbeddingSize(JNIEnv*, jclass, jlong);
}
...
static JNINativeMethod methods[] = {
    ...
    {"nativeSamEncode", "(JLandroid/graphics/Bitmap;)J", (void*)Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamEncode},
    {"nativeSamDecode", "(JJ[F[I[FLandroid/graphics/Bitmap;)Z", (void*)Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamDecode},
    {"nativeSamReleaseEmbedding", "(J)V", (void*)Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamReleaseEmbedding},
    {"nativeSamGetEmbeddingSize", "(J)[I", (void*)Java_com_rapidraw_ai_OnnxInferenceEngine_nativeSamGetEmbeddingSize},
};
