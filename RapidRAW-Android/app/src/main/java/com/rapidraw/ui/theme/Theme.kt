...
/**
    ...
    fun RapidRawTheme(
        ...
        dynamicColor: Boolean = false,  // 默认禁用动态颜色，保持哈苏橙品牌一致性
        ...
        val colorScheme = when {
            ...
            dynamicColor && Build.VERSION.SDK_INT >= Build.VERSION_CODES.S -> {
                ...
                try {
                    ...
                    Log.w("RapidRawTheme", "Failed to apply dynamic color scheme, falling back", e)
                    if (darkTheme) RapidRawDarkColorScheme else RapidRawLightColorScheme
                }
            }
