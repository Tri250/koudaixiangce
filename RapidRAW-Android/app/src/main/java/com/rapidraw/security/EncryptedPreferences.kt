...
class EncryptedPreferences private constructor(context: Context) {
    ...
    private val sharedPreferences: SharedPreferences =
        SafePreferences.get(context, "rapidraw_secure_prefs")
    ...
    fun putString(key: String, value: String) {
        ...
        SafePreferences.putString(sharedPreferences, key, encrypted)
    }

    fun getString(key: String, defaultValue: String? = null): String? {
        val encrypted = SafePreferences.getString(sharedPreferences, key, null) ?: return defaultValue
        return runCatching {
    ...
    fun remove(key: String) {
        SafePreferences.remove(sharedPreferences, key)
    }

    fun clear() {
        SafePreferences.clear(sharedPreferences)
    }

    fun contains(key: String): Boolean = try { sharedPreferences.contains(key) } catch (_: Exception) { false }
