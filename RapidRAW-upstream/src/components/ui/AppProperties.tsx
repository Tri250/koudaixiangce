...
export enum Invokes {
  ...
  ListAndroidSafDirectory = 'list_android_saf_directory',
  ...
  ShareImageOnAndroid = 'share_image_on_android',
  ...
  SeedDefaultPresets = 'seed_default_presets',
  GenerateSkinMask = 'generate_skin_mask',
  AiColorMatch = 'ai_color_match',
...
export interface AppSettings {
   ...
   * Mirrors the Rust-side `cloud_base_url` setting (M11).
   * When unset, frontend cloud calls fall back to the production default.
   */
  cloudBaseUrl?: string;
  /**
   * Optional API key for Qwen-VL based features like AI color matching.
   * Mirrors the Rust-side `vlm_api_key` setting.
   */
  vlmApiKey?: string;
  vlmEndpoint?: string;
  vlmModel?: string;
